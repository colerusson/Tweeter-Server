...
public class FollowersRequest {
     ...
     * Creates an instance.
     *
     * @param followerAlias the alias of the user whose follower are to be returned.
    ...
    /**
     * Returns the number representing the maximum number of follower to be returned by this request.
     *
     * @return the limit.
     */
    public int getLimit() {
